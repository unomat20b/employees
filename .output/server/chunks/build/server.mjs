import { createVNode, mergeProps, Transition, toRefs, toRef, shallowRef, ref, computed, watch, nextTick, watchEffect, provide, onScopeDispose, withDirectives, vShow, Fragment, resolveDirective, reactive, inject as inject$1, onUnmounted, toRaw, createTextVNode, capitalize, h, unref, defineComponent as defineComponent$1, camelize, getCurrentInstance as getCurrentInstance$1, readonly, Suspense, TransitionGroup, isRef, onUpdated, Text, resolveDynamicComponent, markRaw, effectScope, warn, Teleport, cloneVNode, withModifiers, toDisplayString, vModelText, isVNode, Comment, version as version$1, createElementBlock, shallowReactive, hasInjectionContext, resolveComponent, render, useSSRContext, createApp, onErrorCaptured, onServerPrefetch, defineAsyncComponent, isReadonly, withCtx, isShallow, isReactive } from 'vue';
...
function internalUseDefaults() {
  ...
  const componentDefaults = computed(() => {
    var _a3;
    var _a22;
    return (_a22 = defaults.value) == null ? void 0 : _a22[(_a3 = props._as) != null ? _a3 : name];
  });
  const _props = new Proxy(props, {
    get(target, prop) {
      ...
      if (prop === "class" || prop === "style") {
        return [(_a22 = componentDefaults.value) == null ? void 0 : _a22[prop], propValue].filter((v) => v != null);
      } else if (typeof prop === "string" && !propIsDefined(vm.vnode, prop)) {
        return (_b2 = (_a3 = (_b = componentDefaults.value) == null ? void 0 : _b[prop]) != null ? _a3 : (_d = (_c = defaults.value) == null ? void 0 : _c.global) == null ? void 0 : _d[prop]) != null ? _b2 : propValue;
      }
      return propValue;
    }
  });
  ...
  if (options._setup) {
    ...
    options.setup = function setup(props, ctx) {
      ...
      const {
        props: _props,
        provideSubDefaults
      } = internalUseDefaults(props, (_a3 = props._as) != null ? _a3 : options.name, defaults);
...
function createRtl(i18n, options) {
  var _a2;
  const rtl = ref((_a2 = options == null ? void 0 : options.rtl) != null ? _a2 : genDefaults$3());
...
function startOfWeek(date2, locale) {
  ...
  while (d.getDay() !== ((_a2 = firstDay[locale.slice(-2).toUpperCase()]) != null ? _a2 : 0)) {
...
function endOfWeek(date2, locale) {
  var _a2;
  const d = new Date(date2);
  const lastDay = (((_a2 = firstDay[locale.slice(-2).toUpperCase()]) != null ? _a2 : 0) + 6) % 7;
...
function format(value, formatString, locale, formats) {
  var _a2;
  const newDate = (_a2 = date(value)) != null ? _a2 : /* @__PURE__ */ new Date();
...
function getContainer(el) {
  var _a2;
  return (_a2 = getTarget$1(el)) != null ? _a2 : (void 0).scrollingElement || (void 0).body;
}
...
async function scrollTo(_target, _options, horizontal, goTo) {
  ...
  const options = mergeDeep((_a2 = goTo == null ? void 0 : goTo.options) != null ? _a2 : genDefaults$2(), _options);
  const rtl = goTo == null ? void 0 : goTo.rtl.value;
  const target = (_b = typeof _target === "number" ? _target : getTarget$1(_target)) != null ? _b : 0;
  ...
  provide(VuetifyLayoutKey, {
    register: (vm, _ref2) => {
      ...
      const layoutItemStyles = computed(() => {
        ...
        const size = (_a2 = elementSize.value) != null ? _a2 : layoutSize.value;
...
function mounted$2$1(el, binding) {
  return;
}
function unmounted$2$1(el, binding) {
  var _a2;
...
const VAppBar = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const scrollBehavior = computed(() => {
      var _a3;
      var _a2;
      const behavior = new Set((_a3 = (_a2 = props.scrollBehavior) == null ? void 0 : _a2.split(" ")) != null ? _a3 : []);
      return {
    ...
    const height = computed(() => {
      var _a3, _b2;
      var _a2, _b;
      const height2 = Number((_a3 = (_a2 = vToolbarRef.value) == null ? void 0 : _a2.contentHeight) != null ? _a3 : props.height);
  ...
  return {
    ...
    isActive: computed(() => {
      ...
      if (!link.value)
        return false;
      if (!props.exact)
        return (_a4 = (_a3 = link.value.isActive) == null ? void 0 : _a3.value) != null ? _a4 : false;
      if (!route.value)
...
function mounted$1$1(el, binding) {
  updateRipple(el, binding, false);
}
function unmounted$1$1(el) {
  delete el._ripple;
  removeListeners(el);
}
        ...
        default: () => {
          ...
          return [genOverlays(false, "v-alert"), props.border && createVNode("div", {
            ...
            default: () => {
              var _a4;
              var _a32;
              return [(_a4 = (_a32 = slots.title) == null ? void 0 : _a32.call(slots)) != null ? _a4 : props.title];
            }
          }), (_a3 = (_a2 = slots.text) == null ? void 0 : _a2.call(slots)) != null ? _a3 : props.text, (_b = slots.default) == null ? void 0 : _b.call(slots)]), slots.append && createVNode("div", {
            "key": "append",
            ...
            default: () => {
              var _a32;
              return [(_a32 = slots.close) == null ? void 0 : _a32.call(slots, {
...
const VSelectionControl = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      }, [(_a3 = (_b = slots.input) == null ? void 0 : _b.call(slots, {
        model,
        textColorClasses,
        textColorStyles,
        backgroundColorClasses,
      ...
      })) != null ? _a3 : createVNode(Fragment, null, [icon.value && createVNode(VIcon, {
        "key": "icon",
        "icon": icon.value
  ...
  setup(props, _ref) {
    ...
    useRender(() => createVNode(props.tag, {
      ...
      default: () => {
        ...
        }, [(_a3 = (_a2 = slots.prev) == null ? void 0 : _a2.call(slots, slotProps.value)) != null ? _a3 : createVNode(VFadeTransition, null, {
        ...
        default: () => {
          ...
          return [genOverlays(isClickable.value || isActive.value, "v-list-item"), hasPrepend && createVNode("div", {
            ...
            default: () => {
              var _a4;
              var _a3;
              return [(_a4 = (_a3 = slots.title) == null ? void 0 : _a3.call(slots, {
                title: props.title
              })) != null ? _a4 : props.title];
            }
            ...
            default: () => {
              var _a4;
              var _a3;
              return [(_a4 = (_a3 = slots.subtitle) == null ? void 0 : _a3.call(slots, {
                subtitle: props.subtitle
              })) != null ? _a4 : props.subtitle];
            }
    ...
    useRender(() => {
      ...
      return createVNode(props.tag, {
        ...
        default: () => {
          ...
          }, [(_a3 = (_a2 = slots.default) == null ? void 0 : _a2.call(slots)) != null ? _a3 : props.title])];
        }
      });
    });
    return {};
...
const VListChildren = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    return () => {
      var _a3;
      var _a2, _b;
      return (_a3 = (_a2 = slots.default) == null ? void 0 : _a2.call(slots)) != null ? _a3 : (_b = props.items) == null ? void 0 : _b.map((_ref2) => {
        var _a4, _b3;
        var _a32, _b2;
        let {
          children,
        ...
        if (type === "divider") {
          return (_a4 = (_a32 = slots.divider) == null ? void 0 : _a32.call(slots, {
            props: itemProps
          })) != null ? _a4 : createVNode(VDivider, itemProps, null);
        }
        if (type === "subheader") {
        ...
        const slotsWithItem = {
          subtitle: slots.subtitle ? (slotProps) => {
            var _a42;
            return (_a42 = slots.subtitle) == null ? void 0 : _a42.call(slots, {
              ...slotProps,
              item
            });
          } : void 0,
          prepend: slots.prepend ? (slotProps) => {
            var _a42;
            return (_a42 = slots.prepend) == null ? void 0 : _a42.call(slots, {
              ...slotProps,
              item
            });
          } : void 0,
          append: slots.append ? (slotProps) => {
            var _a42;
            return (_a42 = slots.append) == null ? void 0 : _a42.call(slots, {
              ...slotProps,
              item
            });
          } : void 0,
          title: slots.title ? (slotProps) => {
            var _a42;
            return (_a42 = slots.title) == null ? void 0 : _a42.call(slots, {
              ...slotProps,
              item
            });
          } : void 0
  ...
  return new Proxy(target, {
    ...
    getOwnPropertyDescriptor(target2, key) {
      ...
      for (const ref2 of refs) {
        if (!ref2.value)
          continue;
        const descriptor2 = (_a3 = getDescriptor(ref2.value, key)) != null ? _a3 : "_" in ref2.value ? getDescriptor((_a2 = ref2.value._) == null ? void 0 : _a2.setupState, key) : void 0;
        if (descriptor2)
          return descriptor2;
      }
      for (const ref2 of refs) {
          ...
          default: () => {
            ...
            return [hasList && createVNode(VList, mergeProps({
              ...
              default: () => {
                var _a3;
                var _a22, _b, _c;
                return [(_a22 = slots["prepend-item"]) == null ? void 0 : _a22.call(slots), !displayItems.value.length && !props.hideNoData && ((_a3 = (_b = slots["no-data"]) == null ? void 0 : _b.call(slots)) != null ? _a3 : createVNode(VListItem, {
                  ...
                  default: (_ref2) => {
                    ...
                    return (_a4 = (_a32 = slots.item) == null ? void 0 : _a32.call(slots, {
                      item,
                      index,
                      props: itemProps
  ...
  setup(props, _ref) {
    ...
    watch(isFocused, (val, oldVal) => {
      ...
      if (val) {
        ...
        search.value = props.multiple || hasSelectionSlot.value ? "" : String((_a3 = (_a2 = model.value.at(-1)) == null ? void 0 : _a2.props.title) != null ? _a3 : "");
        isPristine.value = true;
                  ...
                  default: (_ref3) => {
                    ...
                    return (_a4 = (_a32 = slots.item) == null ? void 0 : _a32.call(slots, {
                      ...
                      title: () => {
                        var _a5;
                        var _a42, _b2;
                        return isPristine.value ? item.title : highlightResult$1(item.title, (_a42 = getMatches(item)) == null ? void 0 : _a42.title, (_a5 = (_b2 = search.value) == null ? void 0 : _b2.length) != null ? _a5 : 0);
                      }
                    });
                  }
                }), (_c = slots["append-item"]) == null ? void 0 : _c.call(slots)];
        ...
        default: () => {
          ...
          return [hasPrepend && createVNode("div", {
            ...
            default: () => {
              var _a4;
              var _a3;
              return [(_a4 = (_a3 = slots.text) == null ? void 0 : _a3.call(slots)) != null ? _a4 : props.text];
            }
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return createVNode("li", {
        ...
        "style": props.style
      }, [(_a3 = (_a2 = slots == null ? void 0 : slots.default) == null ? void 0 : _a2.call(slots)) != null ? _a3 : props.divider]);
    });
    return {};
  }
});
    ...
    useRender(() => {
      return createVNode(props.tag, {
        ...
        default: () => {
          var _a3, _b2;
          var _a2, _b;
          return [!link.isLink.value ? (_a3 = (_a2 = slots.default) == null ? void 0 : _a2.call(slots)) != null ? _a3 : props.title : createVNode("a", {
      ...
      return createVNode(props.tag, {
        ...
        default: () => {
          ...
          return [hasPrepend && createVNode("li", {
            ...
            return createVNode(Fragment, null, [(_a4 = (_a3 = slots.item) == null ? void 0 : _a3.call(slots, {
              item,
              index
            })) != null ? _a4 : createVNode(VBreadcrumbsItem, mergeProps({
              "key": index,
              ...
              default: slots.divider ? () => {
                var _a42;
                return (_a42 = slots.divider) == null ? void 0 : _a42.call(slots, {
                  item: raw,
                  index
                });
              } : void 0
    ...
    useRender(() => {
      ...
      return createVNode("div", {
        ...
        default: () => {
          var _a4;
          var _a3;
          return [(_a4 = (_a3 = slots.subtitle) == null ? void 0 : _a3.call(slots)) != null ? _a4 : props.subtitle];
        }
...
const VCombobox = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const menu = computed({
      ...
      set: (v) => {
        var _a32;
        if (_menu.value && !v && ((_a32 = vMenuRef.value) == null ? void 0 : _a32.\u03A8openChildren))
          return;
        _menu.value = v;
      }
    });
    ...
    const color = computed(() => {
      var _a32;
      return (_a32 = vTextFieldRef.value) == null ? void 0 : _a32.color;
    });
    const label = computed(() => menu.value ? props.closeText : props.openText);
    const {
      items,
    ...
    const hasChips = computed(() => !!(props.chips || slots.chip));
    const hasSelectionSlot = computed(() => hasChips.value || !!slots.selection);
    const _search = shallowRef(!props.multiple && !hasSelectionSlot.value ? (_a3 = (_a2 = model.value[0]) == null ? void 0 : _a2.title) != null ? _a3 : "" : "");
    const search = computed({
      ...
      set: (val) => {
        ...
        if (val && props.multiple && ((_a32 = props.delimiters) == null ? void 0 : _a32.length)) {
    ...
    watch(model, (value) => {
      ...
      var _a32;
      if (!props.multiple && !hasSelectionSlot.value) {
        _search.value = (_a4 = (_a32 = value[0]) == null ? void 0 : _a32.title) != null ? _a4 : "";
      }
    });
    const {
      filteredItems,
    ...
    const highlightFirst = computed(() => {
      var _a32;
      const selectFirst = props.autoSelectFirst === true || props.autoSelectFirst === "exact" && search.value === ((_a32 = displayItems.value[0]) == null ? void 0 : _a32.title);
      return selectFirst && displayItems.value.length > 0 && !isPristine.value && !listHasFocus.value;
    });
    const menuDisabled = computed(() => props.hideNoData && !displayItems.value.length || props.readonly || (form == null ? void 0 : form.isReadonly.value));
    const listRef = ref();
    ...
    function onKeydown(e) {
      ...
      if (e.key === "ArrowDown" && highlightFirst.value) {
        (_a32 = listRef.value) == null ? void 0 : _a32.focus("next");
      }
    ...
    function onAfterLeave() {
      ...
      if (isFocused.value) {
        isPristine.value = true;
        (_a32 = vTextFieldRef.value) == null ? void 0 : _a32.focus();
      }
    }
    function select(item) {
      let set = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
    ...
    useRender(() => {
      ...
      return createVNode(VTextField, mergeProps({
          ...
          default: () => {
            ...
            return [hasList && createVNode(VList, mergeProps({
              ...
              default: () => {
                var _a5;
                var _a32, _b, _c;
                return [(_a32 = slots["prepend-item"]) == null ? void 0 : _a32.call(slots), !displayItems.value.length && !props.hideNoData && ((_a5 = (_b = slots["no-data"]) == null ? void 0 : _b.call(slots)) != null ? _a5 : createVNode(VListItem, {
                  "title": t(props.noDataText)
                }, null)), createVNode(VVirtualScroll, {
                  "ref": vVirtualScrollRef,
                  "renderless": true,
                  ...
                  default: (_ref4) => {
                    ...
                    return (_a6 = (_a42 = slots.item) == null ? void 0 : _a42.call(slots, {
                      item,
                      index,
                      props: itemProps
                    })) != null ? _a6 : createVNode(VListItem, mergeProps(itemProps, {
                      "role": "option"
                    }), {
                      prepend: (_ref5) => {
                        let {
                      ...
                      title: () => {
                        var _a7;
                        var _a52, _b2;
                        return isPristine.value ? item.title : highlightResult(item.title, (_a52 = getMatches(item)) == null ? void 0 : _a52.title, (_a7 = (_b2 = search.value) == null ? void 0 : _b2.length) != null ? _a7 : 0);
                      }
                    });
                  }
                }), (_c = slots["append-item"]) == null ? void 0 : _c.call(slots)];
        ...
        "append-inner": function() {
          ...
          return createVNode(Fragment, null, [(_a32 = slots["append-inner"]) == null ? void 0 : _a32.call(slots, ...args), (!props.hideNoData || props.items.length) && props.menuIcon ? createVNode(VIcon, {
...
function provideSelection(props, _ref9) {
  ...
  const selected = useProxiedModel(props, "modelValue", props.modelValue, (v) => {
    return new Set(wrapInArray(v).map((v2) => {
      var _a3;
      var _a2;
      return (_a3 = (_a2 = allItems.value.find((item) => props.valueComparator(v2, item.value))) == null ? void 0 : _a2.value) != null ? _a3 : v2;
    }));
  }, (v) => {
    return [...v.values()];
  });
...
const VDataTableColumn = defineFunctionalComponent({
  ...
  return createVNode(Tag, {
    ...
    default: () => {
      var _a22;
      return [(_a22 = slots.default) == null ? void 0 : _a22.call(slots)];
    }
  });
});
      ...
      return createVNode(VDataTableColumn, mergeProps({
        ...
        default: () => {
          ...
          if (column.key === "data-table-select") {
            return (_a3 = (_a22 = slots["header.data-table-select"]) == null ? void 0 : _a22.call(slots, columnSlotProps)) != null ? _a3 : showSelectAll.value && createVNode(VCheckboxBtn, {
        ...
        default: () => [createVNode("div", {
          ...
          chip: (props2) => {
            ...
            return createVNode(VChip, {
              "onClick": ((_a22 = props2.item.raw) == null ? void 0 : _a22.sortable) ? () => toggleSort(props2.item.raw) : void 0,
              "onMousedown": (e) => {
                e.preventDefault();
                e.stopPropagation();
              }
  ...
  setup(props, _ref) {
    ...
    return () => createVNode("tr", {
      ...
      if (column.key === "data-table-group") {
        ...
        return (_a3 = (_a2 = slots["data-table-group"]) == null ? void 0 : _a2.call(slots, {
          item: props.item,
        ...
        })) != null ? _a3 : createVNode(VDataTableColumn, {
    ...
    useRender(() => createVNode("tr", {
      ...
      return createVNode(VDataTableColumn, mergeProps({
        ...
        default: () => {
          ...
          if (column.key === "data-table-select") {
            return (_a3 = (_b = slots["item.data-table-select"]) == null ? void 0 : _b.call(slots, slotProps)) != null ? _a3 : createVNode(VCheckboxBtn, {
    ...
    useRender(() => {
      ...
      if (props.loading && (!props.items.length || slots.loading)) {
        return createVNode("tr", {
          ...
          "colspan": columns.value.length
        }, [(_a3 = (_a2 = slots.loading) == null ? void 0 : _a2.call(slots)) != null ? _a3 : t(props.loadingText)])]);
      }
      ...
      return createVNode(Fragment, null, [props.items.map((item, index) => {
        ...
        }, [slots.item ? slots.item(itemSlotProps) : createVNode(VDataTableRow, itemSlotProps.props, slots), isExpanded(item) && ((_a32 = slots["expanded-row"]) == null ? void 0 : _a32.call(slots, slotProps))]);
      })]);
    });
    return {};
  }
          ...
          return createVNode("div", {
            ...
            item: (itemSlotProps) => createVNode(VVirtualScrollItem, {
              ...
              default: (_ref2) => {
                ...
                return (_a4 = (_a3 = slots.item) == null ? void 0 : _a3.call(slots, {
                  ...itemSlotProps,
                  itemRef
                })) != null ? _a4 : createVNode(VDataTableRow, mergeProps(itemSlotProps.props, {
                  "ref": itemRef,
                  "key": itemSlotProps.internalItem.index,
    ...
    useRender(() => {
      ...
      return createVNode("div", {
        ...
        default: () => {
          ...
          }, [(_a3 = (_a2 = slots.default) == null ? void 0 : _a2.call(slots)) != null ? _a3 : props.header])];
        }
      }), hasAppend && createVNode("div", {
        ...
        return [createVNode("div", {
          ...
          return createVNode("div", {
            ...
            default: () => {
              var _a4;
              var _a3;
              return [(_a4 = (_a3 = slots.day) == null ? void 0 : _a3.call(slots, slotProps)) != null ? _a4 : createVNode(VBtn, slotProps.props, null)];
            }
          })]);
        })])];
      }
...
const VDatePickerMonths = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => createVNode("div", {
      ...
      return (_a3 = (_a2 = slots.month) == null ? void 0 : _a2.call(slots, {
        month,
        i,
        props: btnProps
      })) != null ? _a3 : createVNode(VBtn, mergeProps({
        "key": "month"
      }, btnProps), null);
    })])]));
    return {};
...
const VDatePickerYears = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => createVNode("div", {
      ...
      return (_a3 = (_a2 = slots.year) == null ? void 0 : _a2.call(slots, {
        year,
        i,
        props: btnProps
      })) != null ? _a3 : createVNode(VBtn, mergeProps({
...
const VDatePicker = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const internal = computed(() => {
      var _a22;
      const value = adapter.date((_a22 = model.value) == null ? void 0 : _a22[0]);
    ...
    useRender(() => {
      ...
      return createVNode(VPicker, mergeProps(pickerProps, {
        ...
        title: () => {
          var _a3;
          var _a22;
          return (_a3 = (_a22 = slots.title) == null ? void 0 : _a22.call(slots)) != null ? _a3 : createVNode("div", {
        ...
        header: () => slots.header ? createVNode(VDefaultsProvider, {
          ...
          default: () => {
            var _a22;
            return [(_a22 = slots.header) == null ? void 0 : _a22.call(slots, headerProps)];
          }
...
const VEmptyState = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return createVNode("div", {
      ...
      }, [(_a3 = (_a2 = slots.headline) == null ? void 0 : _a2.call(slots)) != null ? _a3 : props.headline]), hasTitle && createVNode("div", {
        "key": "title",
        ...
        default: () => {
          var _a4;
          var _a32;
          return [(_a4 = (_a32 = slots.actions) == null ? void 0 : _a32.call(slots, {
            props: {
              onClick: onClickAction
            }
          })) != null ? _a4 : createVNode(VBtn, {
            "onClick": onClickAction
          }, null)];
        }
      })])]);
...
const VFab = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const orientation = computed(() => {
      ...
      if (!hasPosition.value)
        return false;
      return (_a2 = props.location.split(" ")[1]) != null ? _a2 : "end";
    });
...
const VFileInput = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const counterValue = computed(() => {
      var _a3;
      var _a2;
      const fileCount = (_a3 = (_a2 = model.value) == null ? void 0 : _a2.length) != null ? _a3 : 0;
      if (props.showSize)
...
const VInfiniteScroll = genericComponent()({
  ...
  setup(props, _ref2) {
    ...
    function renderSide(side, status) {
      ...
      if (status === "empty")
        return (_a3 = (_b = slots.empty) == null ? void 0 : _b.call(slots, slotProps)) != null ? _a3 : createVNode("div", null, [t(props.emptyText)]);
      if (props.mode === "manual") {
        if (status === "loading") {
          return (_b2 = (_c = slots.loading) == null ? void 0 : _c.call(slots, slotProps)) != null ? _b2 : createVNode(VProgressCircular, {
            "indeterminate": true,
            "color": props.color
          }, null);
        }
        return (_c2 = (_d = slots["load-more"]) == null ? void 0 : _d.call(slots, slotProps)) != null ? _c2 : createVNode(VBtn, {
          "variant": "outlined",
          "color": props.color,
          "onClick": onClick
        }, {
      ...
      return (_d2 = (_e = slots.loading) == null ? void 0 : _e.call(slots, slotProps)) != null ? _d2 : createVNode(VProgressCircular, {
        "indeterminate": true,
        "color": props.color
      }, null);
    }
...
function useTouch(_ref) {
  ...
  useToggleScope(isDragging, () => {
    var _a3, _b2;
    var _a2, _b;
    const transform2 = (_a3 = (_a2 = el.value) == null ? void 0 : _a2.style.transform) != null ? _a3 : null;
    const transition = (_b2 = (_b = el.value) == null ? void 0 : _b.style.transition) != null ? _b2 : null;
    watchEffect(() => {
      var _a32, _b22, _c, _d;
      (_b22 = el.value) == null ? void 0 : _b22.style.setProperty("transform", ((_a32 = dragStyles.value) == null ? void 0 : _a32.transform) || "none");
      (_d = el.value) == null ? void 0 : _d.style.setProperty("transition", ((_c = dragStyles.value) == null ? void 0 : _c.transition) || null);
    });
    onScopeDispose(() => {
      var _a32, _b22;
      (_a32 = el.value) == null ? void 0 : _a32.style.setProperty("transform", transform2);
...
const VOtpInput = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    function onPaste(index, e) {
      ...
      e.preventDefault();
      e.stopPropagation();
      const clipboardText = (_a3 = (_a2 = e == null ? void 0 : e.clipboardData) == null ? void 0 : _a2.getData("Text")) != null ? _a3 : "";
    ...
    useRender(() => {
      ...
      return createVNode("div", mergeProps({
        ...
        default: () => {
          var _a4;
          var _a3;
          return [(_a4 = (_a3 = slots.loader) == null ? void 0 : _a3.call(slots)) != null ? _a4 : createVNode(VProgressCircular, {
            "color": typeof props.loading === "boolean" ? void 0 : props.loading,
            "indeterminate": true,
            "size": "24",
            "width": "2"
      ...
      return createVNode(VOverlay, mergeProps({
        ...
        default: () => {
          ...
          return [genOverlays(false, "v-snackbar"), props.timer && !isHovering.value && createVNode("div", {
            ...
            "role": "status",
            "aria-live": "polite"
          }, [(_a3 = (_a2 = slots.text) == null ? void 0 : _a2.call(slots)) != null ? _a3 : props.text, (_b = slots.default) == null ? void 0 : _b.call(slots)]), slots.actions && createVNode(VDefaultsProvider, {
            "defaults": {
              VBtn: {
                variant: "text",
                ripple: false,
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return createVNode("svg", {
        ...
        }, [(_a3 = (_a2 = slots.label) == null ? void 0 : _a2.call(slots, {
          index: i,
          value: item.value
        })) != null ? _a3 : item.value]);
      })]), createVNode("g", {
    ...
    useRender(() => {
      ...
      return createVNode("svg", {
        ...
        return createVNode("text", {
          ...
          "font-size": Number(props.labelSize) || 7
        }, [(_a4 = (_a32 = slots.label) == null ? void 0 : _a32.call(slots, {
          index: i,
          value: item.value
        })) != null ? _a4 : item.value]);
      })]), createVNode("path", {
        ...
        "d": genPath$1(false),
        "fill": "none",
        "stroke": (_b = props.color) != null ? _b : (_a2 = props.gradient) == null ? void 0 : _a2[0]
      }, null)]);
    });
  }
});
    ...
    useRender(() => {
      ...
      return createVNode("div", {
        ...
        default: () => {
          var _a3;
          var _a2;
          return [(_a3 = (_a2 = slots.prev) == null ? void 0 : _a2.call(slots, {
            props: prevSlotProps
          })) != null ? _a3 : createVNode(VBtn, prevSlotProps, null)];
        }
      }), createVNode(VDefaultsProvider, {
        "defaults": {
          VBtn: {
        ...
        default: () => {
          var _a3;
          var _a2;
          return [(_a3 = (_a2 = slots.next) == null ? void 0 : _a2.call(slots, {
            props: nextSlotProps
          })) != null ? _a3 : createVNode(VBtn, nextSlotProps, null)];
        }
      })]);
    });
    return {};
...
const VStepperItem = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      }, [(_a3 = (_a2 = slots.title) == null ? void 0 : _a2.call(slots, slotProps.value)) != null ? _a3 : props.title]), hasSubtitle && createVNode("div", {
        "key": "subtitle",
        "class": "v-stepper-item__subtitle"
      }, [(_b2 = (_b = slots.subtitle) == null ? void 0 : _b.call(slots, slotProps.value)) != null ? _b2 : props.subtitle]), (_c = slots.default) == null ? void 0 : _c.call(slots, slotProps.value)])]), [[resolveDirective("ripple"), props.ripple && props.editable, null]]);
    });
    return {};
  }
});
          ...
          return [hasHeader && createVNode(VStepperHeader, {
            ...
            default: () => [items.value.map((_ref2, index) => {
              ...
              return createVNode(Fragment, null, [!!index && createVNode(VDivider, null, null), createVNode(VStepperItem, item, {
                default: (_a4 = slots[`header-item.${item.value}`]) != null ? _a4 : slots.header,
                icon: slots.icon,
                title: slots.title,
                subtitle: slots.subtitle
              })]);
            ...
            default: () => [items.value.map((item) => createVNode(VStepperWindowItem, {
              ...
              default: () => {
                var _a4;
                var _a32, _b2;
                return (_a4 = (_a32 = slots[`item.${item.value}`]) == null ? void 0 : _a32.call(slots, item)) != null ? _a4 : (_b2 = slots.item) == null ? void 0 : _b2.call(slots, item);
              }
            }))]
          }), (_a2 = slots.default) == null ? void 0 : _a2.call(slots, {
            prev,
            next
          }), hasActions && ((_a3 = (_b = slots.actions) == null ? void 0 : _b.call(slots, {
            next,
            prev
          })) != null ? _a3 : createVNode(VStepperActions, {
            "key": "stepper-actions",
            "onClick:prev": prev,
            "onClick:next": next
          }, slots))];
...
const VTab = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const isSelected = computed(() => {
      var _a3;
      var _a2, _b;
      return (_a3 = (_b = (_a2 = rootEl.value) == null ? void 0 : _a2.group) == null ? void 0 : _b.isSelected.value) != null ? _a3 : false;
    });
    ...
    useRender(() => {
      ...
      return createVNode(VBtn, mergeProps({
        ...
        default: () => {
          var _a3;
          var _a2;
          return createVNode(Fragment, null, [(_a3 = (_a2 = slots.default) == null ? void 0 : _a2.call(slots)) != null ? _a3 : props.text, !props.hideSlider && createVNode("div", {
            "ref": sliderEl,
    ...
    useRender(() => {
      ...
      return createVNode(Fragment, null, [createVNode(VSlideGroup, mergeProps(slideGroupProps, {
        ...
        default: () => {
          var _a3;
          var _a2;
          return [(_a3 = (_a2 = slots.default) == null ? void 0 : _a2.call(slots)) != null ? _a3 : items.value.map((item) => {
            var _a4;
            var _a32;
            return (_a4 = (_a32 = slots.tab) == null ? void 0 : _a32.call(slots, {
              item
            })) != null ? _a4 : createVNode(VTab, mergeProps(item, {
              "key": item.text,
              "value": item.value
            }), {
              default: () => {
                var _a42;
                return (_a42 = slots[`tab.${item.value}`]) == null ? void 0 : _a42.call(slots, {
                  item
                });
              }
            });
        ...
        default: () => {
          ...
          return [items.value.map((item) => {
            ...
            return (_a4 = (_a3 = slots.item) == null ? void 0 : _a3.call(slots, {
              item
            })) != null ? _a4 : createVNode(VTabsWindowItem, {
              "value": item.value
            }, {
              default: () => {
                var _a42;
                return (_a42 = slots[`item.${item.value}`]) == null ? void 0 : _a42.call(slots, {
                  item
                });
              }
            });
...
const VTimelineItem = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    watch(dotRef, (newValue) => {
      ...
      if (!newValue)
        return;
      dotSize.value = (_a3 = (_a2 = newValue.$el.querySelector(".v-timeline-divider__dot")) == null ? void 0 : _a2.getBoundingClientRect().width) != null ? _a3 : 0;
    }, {
      flush: "post"
    });
    useRender(() => {
    ...
    useRender(() => {
      ...
      return createVNode(VOverlay, mergeProps({
        ...
        default: function() {
          ...
          return (_a3 = (_a2 = slots.default) == null ? void 0 : _a2.call(slots, ...args)) != null ? _a3 : props.text;
        }
      });
    });
    return forwardRefs({}, overlay);
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-D1eUM_WG.mjs').then((m) => m.default || m)
  },
  {
    name: "Settings",
    path: "/Settings",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./Settings-R5b0B9_F.mjs').then((m) => m.default || m)
  }
];
...
const __nuxt_component_0 = defineComponent$1({
  ...
  setup(props, context) {
    ...
    const route = injectedRoute === useRoute() ? useRoute$2() : injectedRoute;
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DO1ztxNL.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-COX4k90F.mjs').then((r) => r.default || r));
