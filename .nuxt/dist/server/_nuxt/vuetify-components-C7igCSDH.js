var _a;
import { watch, onScopeDispose, effectScope, shallowRef, Fragment, reactive, computed, watchEffect, toRefs, capitalize, isVNode, Comment, readonly, unref, warn, ref, inject, provide, defineComponent as defineComponent$1, camelize, h, getCurrentInstance as getCurrentInstance$1, toRaw, createVNode, mergeProps, nextTick, Suspense, TransitionGroup, Transition, isRef, toRef, withDirectives, resolveDirective, vShow, onUpdated, Text, resolveDynamicComponent, markRaw, Teleport, cloneVNode, createTextVNode, onUnmounted, withModifiers, toDisplayString, vModelText } from "vue";
...
const VStepperWindow = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const group = inject(VStepperSymbol$1, null);
...
export {
  ...
  DisplaySymbol as i,
  DateOptionsSymbol as j,
  DateAdapterSymbol as k,
  getUid as l,
  mergeDeep as m,
  isObject as n,
  Intersect as o,
...
//# sourceMappingURL=vuetify-components-C7igCSDH.js.map
